...
const HostingOptionCard = ({ icon, price, title }: Props) => {
  return (
    <Tilt className="parallax-effect" perspective={500}>
      <div className="bg-gray-200 rounded-lg h-full p-6 w-full">
        ...
        <button className="px-6 py-2 font-semibold text-blue-950 hover:bg-blue-700 transition-all hover:text-white duration-200 mx-auto border-[1.2px] border-gray-400 border-opacity-25 mt-8 flex items-center space-x-2 rounded-lg">
            <span>See Plan</span>
            <BiArrowToRight/>
        </button>
      </div>
